            ...
            <AccordionDetails sx={{ background: zubgwhite, boxShadow: zubgshadow, color: "white" }}>
              <Box sx={{ paddingTop: 2 }}>
                <Box sx={style.accordian}>
                  <div style={{ color: zubgtext, }} className="!grid !grid-cols-3  pl-2 !place-items-center !bg-[#281970] !bg-opacity-5">
                    <span>S.No.</span>
                    <span>User Id</span>
                  ...
                  {result?.level_1?.map((i, index) => {
                    return (
                      <div style={{ color: zubgtext, }} className="!grid !grid-cols-3  pl-2 !place-items-center">
                        <span>{index + 1}</span>
